...
> 🛑 **은퇴 예정 (2026-06-29)** — 덱 시스템 SoT = v4 하네스(`.claude/skills/deck-harness/` + `PRD_v4.md`). 이 파이썬 B는 v4에 검증 부품(engine.py 차트·dig 앞절반)을 기증 중 → 흡수 완료 후 은퇴·도장. 새 덱 작업은 v4로 ([[project_tickdeck_harness_v4]]).
