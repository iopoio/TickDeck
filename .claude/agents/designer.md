...
- **간지 리듬 레버**: `hero_title: true`(한 단어급 초대형 타이포 — 이 장엔 차트·장식 금지), `divider_variant: "accent"`(테마색 풀블리드 — 4~6장마다 색 리듬 전환, 잉크 간지와 번갈아). 데모 = `_workspace/20260703_grammar_demo/deck.pdf`.
