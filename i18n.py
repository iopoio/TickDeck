...
T_EN = {'meta_title': 'TickDeck — Turn Your Website into a PPT',
 ...
 't_js': {'js_tokens_unit': '',
          ...
          'js_history_purpose_labels': {'auto': 'AI Recommended',
                                        'brand': 'Brand Intro',
...
T_LANDING_KO = {
    'landing_title': 'TickDeck — 당신의 웹사이트를 PPT로',
    'landing_description': 'URL만 입력하면 AI가 브랜드 맞춤형 프레젠테이션을 자동으로 만들어드립니다. 5분 이내 완성.',
    'landing_meta_canonical': 'https://tickdeck.site/',
    'landing_og_url': 'https://tickdeck.site/',
    'landing_og_title': 'TickDeck — 당신의 웹사이트를 PPT로',
    'landing_og_description': '복잡한 도구나 디자인 스킬 없이, URL 하나면 전문가 수준의 PPT가 완성됩니다.',
    'landing_og_locale': 'ko_KR',
    'landing_twitter_title': 'TickDeck — 당신의 웹사이트를 PPT로',
    'landing_twitter_description': 'URL 하나면 AI가 브랜드 맞춤형 PPT를 5분 이내에 완성합니다.',
    'landing_keywords': 'PPT 자동생성, 회사소개서, AI PPT, 웹사이트 PPT, 프레젠테이션 자동화, TickDeck',
    'landing_nav_lang_href': '/en',
    'landing_nav_lang_label': '🌐 EN',
    'landing_nav_logo_href': '/',
    'landing_app_href': '/app',
    'landing_nav_cta': '시작하기',
    'landing_hero_badge': 'AI 프레젠테이션 생성기',
    'landing_hero_h1': '당신의 웹사이트를<br><em>PPT로</em> 만들어드립니다',
    'landing_hero_sub': '복잡한 도구나 디자인 스킬이 필요 없습니다.<br>URL 하나면 AI가 알아서 브랜드에 맞는<br>프레젠테이션을 <strong>5분 이내에</strong> 완성합니다.',
    'landing_hero_cta': '무료로 시작하기',
    'landing_hero_token': '가입 시 <strong>무료 토큰 2개</strong> 제공 · 추가 충전 가능',
    'landing_steps_h2': '<span>3단계</span>면 충분합니다',
    'landing_steps_p': '복잡한 과정은 없습니다',
    'landing_step1_h3': 'URL 입력',
    'landing_step1_p': '홈페이지 주소를 입력하면<br>AI가 자동으로 사이트를 분석합니다',
    'landing_step2_h3': 'AI 슬라이드 제작',
    'landing_step2_p': '브랜드 컬러, 로고, 핵심 정보를<br>바탕으로 슬라이드를 구성합니다',
    'landing_step3_h3': 'PPT 다운로드',
    'landing_step3_p': 'PPTX 또는 PDF로<br>바로 다운로드할 수 있습니다',
    'landing_value_h2': 'AI를 몰라도,<br>디자인을 몰라도',
    'landing_value_p': 'TickDeck은 당신의 웹사이트에서 브랜드 정체성을 읽어내고, 전문가 수준의 회사소개서를 자동으로 완성합니다.',
    'landing_vfi1_h4': '브랜드 컬러 자동 추출',
    'landing_vfi1_p': '웹사이트의 CSS, 로고, 파비콘에서 브랜드 컬러를 분석합니다',
    'landing_vfi2_h4': '설득력 있는 구성',
    'landing_vfi2_p': '문제 제기부터 해결책까지, 논리적인 흐름으로 구성됩니다',
    'landing_vfi3_h4': '5분 이내 완성',
    'landing_vfi3_p': 'URL 입력부터 PPT 다운로드까지, 기다리는 동안 커피 한 잔이면 됩니다',
    'landing_audience_h2': '<span class="g">이런 분들</span><span class="b">이 사용합니다</span>',
    'landing_audience_p': 'IT에 익숙하지 않아도, 디자인을 못 해도 괜찮습니다',
    'landing_ac1_h4': '중소기업 대표님',
    'landing_ac1_p': '투자자, 파트너에게 보여줄 회사소개서가 급하게 필요할 때. 디자인 외주 없이 바로 완성합니다.',
    'landing_ac2_h4': '영업·사업개발 담당자',
    'landing_ac2_p': '고객사마다 다른 제안서를 빠르게 만들어야 할 때. URL만 바꾸면 맞춤 자료가 됩니다.',
    'landing_ac3_h4': '스타트업 팀',
    'landing_ac3_p': 'IR 자료, 브랜드 소개, 서비스 설명이 동시에 필요할 때. 용도별로 키만 바꿔 생성합니다.',
    'landing_bcta_h2': '지금 바로 시작하세요',
    'landing_bcta_p': 'URL 하나로 전문가 수준의 프레젠테이션을 만들어 보세요',
    'landing_bcta_btn': '무료로 시작하기',
    'landing_footer_terms': '이용약관',
    'landing_footer_privacy': '개인정보처리방침',
    'landing_footer_contact': '문의하기',
    'landing_footer_coffee_btn': '☕ 커피 한 잔 후원하기',
    'landing_modal_coffee_title': '☕ 커피 한 잔 후원하기',
    'landing_modal_coffee_desc': '서비스 유지비로 소중히 사용됩니다',
    'landing_modal_coffee_qr_hint': '모바일: 이미지 클릭 · PC: QR 스캔',
    'landing_modal_coffee_intl': '해외 결제',
    'landing_modal_coffee_close': '닫기',
    'landing_modal_coffee_alt': '카카오페이 QR'
}

T_LANDING_EN = {
    'landing_title': 'TickDeck — Turn Your Website into a PPT',
    'landing_description': 'Just enter a URL and AI creates a brand-matched presentation automatically. Ready in under 5 minutes.',
    'landing_meta_canonical': 'https://tickdeck.site/en',
    'landing_og_url': 'https://tickdeck.site/en',
    'landing_og_title': 'TickDeck — Turn Your Website into a PPT',
    'landing_og_description': 'No design skills needed. Just one URL and AI builds a professional presentation for you.',
    'landing_og_locale': 'en_US',
    'landing_twitter_title': 'TickDeck — Turn Your Website into a PPT',
    'landing_twitter_description': 'One URL. AI builds a brand-matched presentation in under 5 minutes.',
    'landing_keywords': 'AI presentation generator, website to PPT, automatic PowerPoint, brand presentation, TickDeck',
    'landing_nav_lang_href': '/',
    'landing_nav_lang_label': '🇰🇷 한국어',
    'landing_nav_logo_href': '/en',
    'landing_app_href': '/en/app',
    'landing_nav_cta': 'Get Started',
    'landing_hero_badge': 'AI Presentation Generator',
    'landing_hero_h1': 'Turn Your Website<br>into a <em>PPT</em>',
    'landing_hero_sub': 'No design tools or skills needed.<br>Just one URL and AI builds a brand-matched<br>presentation in <strong>under 5 minutes</strong>.',
    'landing_hero_cta': 'Get Started Free',
    'landing_hero_token': '<strong>2 free tokens</strong> on signup · Recharge available',
    'landing_steps_h2': 'Just <span>3 Steps</span>',
    'landing_steps_p': 'No complicated process',
    'landing_step1_h3': 'Enter URL',
    'landing_step1_p': 'Paste your website URL and<br>AI automatically analyzes it',
    'landing_step2_h3': 'AI Builds Slides',
    'landing_step2_p': 'Brand colors, logo, and key info<br>are crafted into a presentation',
    'landing_step3_h3': 'Download PPT',
    'landing_step3_p': 'Download as PPTX or PDF<br>instantly',
    'landing_value_h2': 'No AI expertise.<br>No design skills.',
    'landing_value_p': 'TickDeck reads your website\'s brand identity and automatically creates a professional company presentation.',
    'landing_vfi1_h4': 'Auto Brand Color Detection',
    'landing_vfi1_p': 'Extracts brand colors from CSS, logo, and favicon',
    'landing_vfi2_h4': 'Persuasive Structure',
    'landing_vfi2_p': 'From problem statement to solution — logical flow built in',
    'landing_vfi3_h4': 'Ready in Under 5 Min',
    'landing_vfi3_p': 'From URL input to PPT download — just enough time for a coffee',
    'landing_audience_h2': '<span class="g">Who</span> <span class="b">uses TickDeck</span>',
    'landing_audience_p': 'No tech background needed. No design skills required.',
    'landing_ac1_h4': 'Small Business Owners',
    'landing_ac1_p': 'Need a company deck for investors or partners? Get it done instantly without hiring a designer.',
    'landing_ac2_h4': 'Sales & BD Teams',
    'landing_ac2_p': 'Create tailored proposals for each client. Just swap the URL and get a custom presentation.',
    'landing_ac3_h4': 'Startup Teams',
    'landing_ac3_p': 'IR decks, brand intros, and service overviews — all from one URL, generated in minutes.',
    'landing_bcta_h2': 'Start Now',
    'landing_bcta_p': 'Create a professional presentation from just one URL',
    'landing_bcta_btn': 'Get Started Free',
    'landing_footer_terms': 'Terms',
    'landing_footer_privacy': 'Privacy',
    'landing_footer_contact': 'Contact',
    'landing_footer_coffee_btn': '☕ Buy me a coffee',
    'landing_modal_coffee_title': '☕ Buy me a coffee',
    'landing_modal_coffee_desc': 'Your support helps keep the service running',
    'landing_modal_coffee_qr_hint': 'Mobile: tap image · PC: scan QR',
    'landing_modal_coffee_intl': 'International',
    'landing_modal_coffee_close': 'Close',
    'landing_modal_coffee_alt': 'KakaoPay QR'
}
