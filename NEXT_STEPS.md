...
## 🚨 2026-07-06 최신 — 실행 SoT: `REBUILD_PLAN.md`
후추님 지시 "덱 제작보다 계획과 이탈 방지가 먼저" → **REBUILD_PLAN.md가 실행 SoT** (Phase A 만드는 법 → B 5차 제작 → C 재노출 실험·성공기준 사전고정). 배경 진단은 `HANDOFF_2026-07-06.md`(결함 A 현학·B 독자수준 + 부록2 p09 풀어쓰기 대조·부록3 조사력=PDF 0건·덱≈퍼플렉시티 판정). 계획에 없는 작업은 계획 수정 커밋 먼저.
