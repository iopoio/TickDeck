...
SLIDES = [
    ...
    {"layout": "closing", "eyebrow": "Agenda",
     "title": "AI가 기본이 된 시대, 차별화는 어디서 오는가",
     "bullets": ["01 변화 — AI가 마케팅의 기본값, 도입은 끝난 논쟁",
                 "02 역설 — AI가 흔할수록 사람이 비싸짐",
                 "03 지각 변동 — 발견·고객·진정성·팬덤·재투자",
                 "04 해자 — 다섯은 한 곳, 인간 신뢰가 유일한 해자",
                 "05 실행 — 마케터가 내일부터 바꿀 것"]},
    ...
    {"layout": "kpi", "eyebrow": "역설 · 진정성 프리미엄",
     "title": "위조 가능 시대, 신뢰성이 마지막 차별점",
     "sub": "storytelling에서 proof design으로 — 진짜를 증명하는 것이 경쟁우위",
     "value": "65%", "delta": "진짜/가짜 구분 어려움 (영국)",
     "aux": [{"label": "'authentic'이 신뢰 핵심 동의", "value": "97%"},
             {"label": "마지막 차별점", "value": "신뢰성"},
             {"label": "전환 방향", "value": "proof design"}],
     "foot": "출처: WPP Media · Ogilvy Social Lab · AMA 2026"},
    ...
    {"layout": "funnel", "eyebrow": "해자 · 수렴",
     "title": "다섯 갈래는 한 곳을 가리킨다",
     "sub": "발견(새 유통)·고객(최종 결정자)·진정성(차별화 통화)·팬덤(retention)·재투자(성장 승수)",
     "steps": ["발견 · 고객 · 진정성 · 팬덤 · 재투자", "효율로 번 것을 신뢰에 재투자", "인간 신뢰 = 유일한 해자"]},
    ...
    {"layout": "table", "eyebrow": "참고자료 · Sources",
     "title": "근거 출처 10",
     "cols": ["#", "출처", "주제"],
     "rows": [["1", "GWI — Connecting the Dots 2026", "미디어·발견"],
              ["2", "McKinsey — State of Marketing Europe", "효율·재투자"],
              ["3", "Deloitte — 2026 Digital Media Trends", "팬덤 LTV"],
              ["4", "WPP Media — UK Trends 2026", "이중 청중"],
              ["5", "Ogilvy Social Lab · WGSN", "진정성"],
              ["6", "AMA · KPMG · PwC", "흐름·실행"]]},
]
