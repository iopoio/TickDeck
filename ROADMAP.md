...
### 문서 (4건)
- ✅ **REVIEW_2026-03-30.md** — 프로덕트 종합 리뷰
- ✅ **DESIGN_REVIEW_2026-03-30.md** — 디자인 리뷰 (4개 스킬 기준)
...
1. **Playwright MCP QA 자동화** — 설치 완료, 스크립트 작성 필요
2. **M3 getSlideLayout 리팩토링** — 180줄 → 모듈화 (대규모)
3. **M13 업종별 프롬프트** — 헬스케어/핀테크/건설 특화
4. **테스트 계정 정리** — Rate Limit 테스트 더미 11개 삭제
